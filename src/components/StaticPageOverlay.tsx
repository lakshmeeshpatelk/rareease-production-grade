...
const CONTENT: Record<PageType, { title: string; date: string; sections: { heading: string; body: string }[] }> = {
  privacy: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Notwithstanding anything under this Policy, as required under applicable Indian laws, we will not be storing any credit card, debit card or any other similar card data of yours. All data or information collected from you will be strictly in accordance with applicable laws and guidelines. We do not store any payment information on our servers. All payments are processed using Razorpay. Your financial information is transmitted directly to Razorpay using industry-standard TLS encryption.',
      },
      {
  ...
  terms: {
    ...
    sections: [
      ...
      { heading: '4. Payment', body: 'We accept all major credit/debit cards, UPI, net banking, and wallets via Razorpay. Payment must be received in full before dispatch.' },
