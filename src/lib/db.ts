...
export function normaliseProduct(raw: Record<string, unknown>): Product {
  ...
  return {
    ...
    homepage_featured: raw.homepage_featured as boolean | undefined,
    homepage_sort_order: raw.homepage_sort_order as number | undefined,
    collection_sort_order: raw.collection_sort_order as number | undefined,
